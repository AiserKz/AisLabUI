  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-base-100 text-base-content">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-clip">
        <motion.img
          animate={{ y: [0, 10, 0, 10], x: [5, 0, 5, 0] }}
          transition={{ repeat: Infinity, duration: 5, repeatType: "reverse" }}
          src="/money.png"
          alt=""
          className="absolute top-30 left-30 w-100 z-40 select-none "
        />
        {/* Background Shapes */}
        ...
        <div className="container mx-auto px-4 z-10 text-center hero-3d-container">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-base-content/70 max-w-2xl mx-auto leading-relaxed">
              ...
              . Создавайте премиальные интерфейсы быстрее, не переписывая один и
              тот же код.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-4xl md:text-5xl font-bold leading-tight">
            <span className="scroll-text-highlight">
              Мы верим в простоту и скорость. AisLabUi создан, чтобы стать
              мостом между "сырыми" утилитами и готовыми функциональными
              компонентами. Хватит изобретать велосипед. Начните создавать
              красивые, отзывчивые и доступные интерфейсы одной строкой кода.
      ...
      <section className="py-32 relative overflow-clip">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex justify-center gap-4">
            <Link
              to="/native"
              className="btn btn-primary btn-lg px-12 shadow-xl hover:shadow-primary/50 transition-shadow"
            >
              Смотреть компоненты
            </Link>
            <a
