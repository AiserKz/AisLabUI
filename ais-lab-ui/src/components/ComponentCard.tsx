  ...
  return (
    ...
    >
      <div className="card bg-base-100 border border-base-300 hover:border-primary/50 transition-all duration-300 overflow-hidden h-full hover:shadow-xl">
        ...
        <div className="relative h-52 bg-linear-to-br from-base-200/50 to-base-300/50 backdrop-blur-sm overflow-hidden">
          {/* Preview Content */}
        ...
        <div className="card-body p-6">
          <div className="flex items-start gap-3">
            <div className={`p-2.5 rounded-box bg-${color}/10 shrink-0`}>
